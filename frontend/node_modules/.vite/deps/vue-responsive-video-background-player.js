...
(function() {
  ...
  try {
    if (typeof document != "undefined") {
      ...
      e.appendChild(document.createTextNode(".video-wrapper[data-v-f8afdaf5]{display:flex;justify-content:center;align-items:center;width:100%;height:100%;position:absolute;overflow:hidden;z-index:0}.fade[data-v-f8afdaf5]{backface-visibility:hidden}.fade-enter-active[data-v-f8afdaf5],.fade-leave-active[data-v-f8afdaf5]{transition:opacity 1s}.fade-enter[data-v-f8afdaf5],.fade-leave-to[data-v-f8afdaf5]{opacity:0}video[data-v-f8afdaf5]{visibility:visible;pointer-events:none;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);height:100%;width:100%}.video-buffering[data-v-21ec9d8c]{width:100%;overflow:hidden;background-size:cover;background-position:center;height:100%;top:0;left:0;position:absolute}.video-overlay[data-v-95abe06c]{height:100%;width:100%;top:0;left:0;position:absolute}.vue-responsive-videobg[data-v-7649c24c]{background:none;position:relative;width:100%;overflow:hidden}.vue-responsive-videobg .videobg-content[data-v-7649c24c]{position:absolute;top:0;left:0;width:100%;height:100%}")), document.head.appendChild(e);
    }
  } catch (t) {
...
var R = ["src", "res", "autoplay"];
var S = (e) => Array.isArray(e) ? e.length === 0 ? true : m(e, R) : false;
var m = (e, t) => t.length === 1 ? f(e, t[0]) : f(e, t[0]) * m(e, t.slice(1));
var f = (e, t) => {
...
var W = (e) => e != null && e.constructor.name === "Object";
...
var C = { class: "video-wrapper" };
var F = ["muted", "loop", "preload"];
var I = ["src", "type"];
function M(e, t, o, r, i, n) {
  return openBlock(), createBlock(Transition, { name: e.transition }, {
    default: withCtx(() => [
      withDirectives(createBaseVNode("div", C, [
        createBaseVNode("video", {
          ...
          loop: e.loop,
          preload: e.preload,
          style: normalizeStyle(n.styleObject)
        }, [
...
var z = a(T, [["render", M], ["__scopeId", "data-v-f8afdaf5"]]);
var L = {
  props: {
    poster: {
      type: String,
...
function q(e, t, o, r, i, n) {
  return openBlock(), createElementBlock("div", {
    ...
    style: normalizeStyle(n.image)
  }, null, 4);
}
var A = a(L, [["render", q], ["__scopeId", "data-v-21ec9d8c"]]);
var H = {
  props: {
    overlay: {
      type: String,
...
function N(e, t, o, r, i, n) {
  return openBlock(), createElementBlock("div", {
    class: "video-overlay",
    style: normalizeStyle({ background: o.overlay })
  }, null, 4);
}
var D = a(H, [["render", N], ["__scopeId", "data-v-95abe06c"]]);
var v = (e, t) => {
  let o = "null";
  return (...r) => {
    o === "null" && (o = setTimeout(() => {
...
var K = { class: "videobg-content" };
function Q(e, t, o, r, i, n) {
  const $ = resolveComponent("video-poster"), g = resolveComponent("video-player"), b = resolveComponent("video-overlay");
  return openBlock(), createElementBlock("section", J, [
    e.current.poster || e.poster ? (openBlock(), createBlock($, {
      key: 0,
      poster: e.current.poster || e.poster
    }, null, 8, ["poster"])) : createCommentVNode("", true),
    createVNode(g, {
      ref: "player",
      src: e.current.src,
      muted: e.muted,
    ...
    e.overlay ? (openBlock(), createBlock(b, {
      key: 1,
      overlay: e.overlay
    }, null, 8, ["overlay"])) : createCommentVNode("", true),
    createBaseVNode("div", K, [
      renderSlot(e.$slots, "default", {}, void 0, true)
    ])
  ], 512);
}
var X = a(U, [["render", Q], ["__scopeId", "data-v-7649c24c"]]);
var Z = {
  install(e) {
